...
<div class="mb-6 flex justify-between items-center">
    ...
    <div class="space-x-2">
        <a href="{{ route('admin.courses.edit', $course) }}" class="bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600">
            Редактировать
        </a>
...
<div class="bg-white rounded-lg shadow p-6">
    <dl class="grid grid-cols-1 gap-4">
        ...
        <div>
            ...
            <dd class="mt-1 text-gray-900">{{ $course->instructor->name }}</dd>
        </div>
        <div>
